...
activities = {
    ...
    "Swimming Club": {
        "description": "Lap swimming, stroke improvement, and water fitness",
        "schedule": "Tuesdays and Fridays, 3:30 PM - 5:00 PM",
        "max_participants": 16,
        "participants": ["ethan@mergington.edu", "zara@mergington.edu"]
    },
    "Art Club": {
    ...
    "Drama Society": {
        "description": "Acting workshops and stage productions for drama enthusiasts",
    ...
    "Science Club": {
        "description": "Investigate experiments, research projects, and science fair preparation",
